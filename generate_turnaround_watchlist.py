...
def main():
    ...
    write_csv(leaders, 'leaders_latest.csv', leaders_fields)
    if leaders:
    ...
    write_csv(csv_rows, 'turnaround_latest.csv', turnaround_fields)
    ...
    write_json(summary, 'turnaround_summary.json')
