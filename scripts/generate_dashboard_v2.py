...
<div class="tc" id="t5">
  ...
  <div style="margin-bottom:12px;background:#171b20;border:1px solid #222830;border-radius:6px;padding:10px 12px">
    <div style="font-size:9px;font-family:'Space Mono',monospace;color:#9CA3AF;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;font-weight:600">LEGENDA EXIT MONITOR</div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px 12px">
      ...
      <div style="font-size:11px;color:#9CA3AF"><span style="display:inline-block;background:#222830;color:#9CA3AF;border-radius:3px;padding:1px 5px;font-family:'Space Mono',monospace;font-weight:700;font-size:10px;margin-right:4px">Rank Chg</span> Perubahan posisi rank (positif = naik peringkat, negatif = turun)</div>
      <div style="font-size:11px;color:#9CA3AF"><span style="display:inline-block;background:#222830;color:#9CA3AF;border-radius:3px;padding:1px 5px;font-family:'Space Mono',monospace;font-weight:700;font-size:10px;margin-right:4px">RS20</span> Relative Strength 20 hari terakhir (positif = outperforming IHSG)</div>
      <div style="font-size:11px;color:#9CA3AF"><span style="display:inline-block;background:#222830;color:#9CA3AF;border-radius:3px;padding:1px 5px;font-family:'Space Mono',monospace;font-weight:700;font-size:10px;margin-right:4px">RS Chg 20D</span> Perubahan RS dalam 20 hari (positif = momentum naik)</div>
      <div style="font-size:11px;color:#9CA3AF"><span style="display:inline-block;background:#222830;color:#9CA3AF;border-radius:3px;padding:1px 5px;font-family:'Space Mono',monospace;font-weight:700;font-size:10px;margin-right:4px">vs MA50/100</span> Posisi harga terhadap MA50/MA100 (DI ATAS/DI BAWAH)</div>
      <div style="font-size:11px;color:#9CA3AF"><span style="display:inline-block;background:#222830;color:#9CA3AF;border-radius:3px;padding:1px 5px;font-family:'Space Mono',monospace;font-weight:700;font-size:10px;margin-right:4px">DD Entry</span> Drawdown dari harga entry (semakin negatif semakin dalam kerugian)</div>
    </div>
  </div>
