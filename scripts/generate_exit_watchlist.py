...
EXIT_CSV = Path('data/current/exit_watchlist_latest.csv')
EXIT_JSON = Path('data/state/exit_summary.json')
ENTRY_PRICES_FILE = Path('data/state/exit_entry_prices.json')
